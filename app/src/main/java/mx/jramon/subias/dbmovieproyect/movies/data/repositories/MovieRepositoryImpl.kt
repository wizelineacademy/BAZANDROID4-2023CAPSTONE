...
import mx.jramon.subias.dbmovieproyect.movies.data.MovieRemoteDataSource
...
class MovieRepositoryImpl @Inject constructor(
    ...
    override fun getPopularMovies(page: Int): Single<List<MovieEntity>> {
       return movieRemoteDataSource.getPopularMovie(page).map { it.results }.subscribeOn(Schedulers.io())
    }
