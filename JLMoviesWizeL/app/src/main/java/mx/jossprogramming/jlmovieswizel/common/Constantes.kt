package mx.jossprogramming.jlmovieswizel.common
...
object Constantes {
    ...
    val ERROR_USER_IS_ALREADY_CREATED = "The email address is already in use by another account."
    val PARAM_ID_MOVIE = "PARAM_ID_MOVIE"
}